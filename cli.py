...
Examples:
  ...
  python main.py /home/user/documents "\d{3}-\d{2}-\d{4}" -inc "^report" --include-mode beginswith -v
    ...
    parser.add_argument("--include-mode", choices=["beginswith", "full"], default="full",
                        help="Mode for include patterns (default: full)")
    parser.add_argument("--ignore-mode", choices=["beginswith", "full"], default="full",
                        help="Mode for ignore patterns (default: full)")
